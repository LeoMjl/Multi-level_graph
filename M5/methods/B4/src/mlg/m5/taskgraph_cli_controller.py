...
class TaskGraphCodexController:
    ...
    def __init__(
        ...
        *,
        ...
        self.dependency_config = dependency_config or PaperDependencyConfig()
        ...
        self.controller_policy = {
            ...
            "controller_revision": "m5-taskgraph-codex-cli-controller-v1",
            "backend": "codex_cli_ephemeral",
            "isolation": isolation,
    ...
    def _validate_chapter(text: str, payload: dict[str, Any] | None) -> None:
        ...
        if not 2000 <= count <= 3000:
            raise ValueError(f"chapter has {count} Han characters; expected 2000..3000")
